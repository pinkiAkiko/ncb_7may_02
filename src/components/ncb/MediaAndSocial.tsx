...
export function MediaAndSocial() {
  return (
    <section aria-labelledby="media-title" className="bg-background py-16">
      <div className="mx-auto max-w-7xl px-4 grid lg:grid-cols-[2fr_1fr] gap-8 lg:items-stretch">
        <div>
          ...
          <Button variant="outline" className="mt-5 border-navy text-navy hover:bg-navy hover:text-navy-foreground rounded-none">
            View Gallery <ArrowRight className="size-4" />
          </Button>
        </div>

        <aside aria-labelledby="social-title" className="flex flex-col gap-4">
          ...
          <div className="bg-card border border-border p-6 flex-1 flex flex-col">
            <h3 className="text-base font-bold uppercase tracking-wider text-saffron">Latest Posts</h3>
